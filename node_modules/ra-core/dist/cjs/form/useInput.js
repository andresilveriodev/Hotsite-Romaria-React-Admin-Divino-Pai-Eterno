...
var useInput = function (props) {
    ...
    // @ts-ignore
    var parse = (0, util_1.useEvent)(parseProp);
    ...
    var _c = (0, react_hook_form_1.useController)(__assign(__assign({ name: finalName, defaultValue: (0, get_1.default)(record, finalSource, defaultValue), rules: {
        ...
        disabled: options.disabled || undefined })), controllerField = _c.field, fieldState = _c.fieldState, formState = _c.formState;
